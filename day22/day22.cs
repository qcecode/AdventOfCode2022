...
Console.WriteLine("Part 1: " + Day22.PuzzleOne());
Console.WriteLine("Part 2: " + Day22.PuzzleTwo());

public static class Day22
{
    public static int PuzzleOne()
    {
        var input = File.ReadAllText("C:\\Users\\qcec\\Source\\Repos\\AdventOfCode2022\\day22\\input22.txt");
    ...
    public static int PuzzleTwo(int length = 50)
    {
        var input = File.ReadAllText("C:\\Users\\qcec\\Source\\Repos\\AdventOfCode2022\\day22\\input22.txt");
        var parts = input.Split($"{Environment.NewLine}{Environment.NewLine}").ToArray();
        var matches = Regex.Matches(parts.Last(), @"(\d+)([RL]?)");
